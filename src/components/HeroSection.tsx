  ...
  return (
    <>
      <section className='bg-[#0a0908] w-full text-center pt-[7.5rem]'>
        <p className='text-[2rem]'>Hey! I'm <span className='text-[#A9927D]'>Mariyam Nadeem</span></p>

        <p className='text-[2rem]'><span className='text-[#442f1b]'>I</span>'m <span className='text-[#A9927D]'>A F</span>ront <span className='text-[#A9927D]'>E</span>nd <span className='text-[#A9927D]'>W</span>eb <span className='text-[#A9927D]'>D</span>eveloper</p>
